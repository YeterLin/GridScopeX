...
MainWindow::MainWindow(const QString &fileToLoad, Settings &settings) : mSettings(settings)
{
    ...
    // 创建一个临时窗口来显示启动信息
    QWidget *splashWidget = new QWidget();
    splashWidget->setWindowFlags(Qt::FramelessWindowHint);  // 无边框


    QMovie *movie = new QMovie(":/images/loading.gif");


    QLabel *label = new QLabel(splashWidget);
    ...
    splashWidget->setFixedSize(912, 381);
    splashWidget->show();
